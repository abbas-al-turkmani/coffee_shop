...
class Failuer {
  ...
  const Failuer({required this.error, required this.statusCode});
  ...
  factory Failuer.handleExeption(Object exception) {
    if (exception is DioException) {
      switch (exception.type) {
        case DioExceptionType.connectionTimeout:
          return Failuer(error: 'Connection Timeout!', statusCode: -1);
    ...
    return const Failuer(error: 'Error happened!', statusCode: -1);
  }
